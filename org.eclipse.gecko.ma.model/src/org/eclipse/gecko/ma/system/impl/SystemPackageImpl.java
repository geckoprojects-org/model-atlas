 ...
 */
package org.eclipse.gecko.ma.system.impl;
...
import org.eclipse.gecko.ma.system.XMLContainer;
...
public class SystemPackageImpl extends EPackageImpl implements SystemPackage {
	 ...
	 * @see org.eclipse.gecko.ma.system.SystemPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(containerEClass, org.eclipse.gecko.ma.system.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Elements(), ecorePackage.getEObject(), null, "elements", null, 0, -1, org.eclipse.gecko.ma.system.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation
		  (this,
		   source,
		   new String[] {
			   "basePackage", "org.eclipse.gecko.ma",
			   "copyrightText", "Copyright (c) 2012 - 2024 Data In Motion and others.\nAll rights reserved. \n\nThis program and the accompanying materials are made\navailable under the terms of the Eclipse Public License 2.0\nwhich is available at https://www.eclipse.org/legal/epl-2.0/\n\nSPDX-License-Identifier: EPL-2.0\n \nContributors:\n     Data In Motion - initial API and implementation",
			   "complianceLevel", "17.0",
			   "modelDirectory", "/org.eclipse.gecko.ma.model/src",
			   "oSGiCompatible", "true"
		   });
	}
