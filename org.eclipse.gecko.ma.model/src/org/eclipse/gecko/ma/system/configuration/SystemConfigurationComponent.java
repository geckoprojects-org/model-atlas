 ...
 */
package org.eclipse.gecko.ma.system.configuration;
...
import org.eclipse.gecko.ma.system.SystemFactory;
import org.eclipse.gecko.ma.system.SystemPackage;

import org.eclipse.gecko.ma.system.impl.SystemPackageImpl;

import org.eclipse.gecko.ma.system.util.SystemResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.gecko.ma.system.util.SystemResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.eclipse.gecko.ma.system.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.gecko.ma.system.SystemFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.gecko.ma.system\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.gecko.ma.system.SystemPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.gecko.ma.system\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.gecko.ma.system\"" })
